...
def main_worker(args):
    ...
    if not os.path.isdir('pretrained_model/' + args.arch + '/' + args.set):
        os.mkdir('pretrained_model/' + args.arch + '/' + args.set)
...
if __name__ == "__main__":
    # setup: python train.py --gpu 1 --arch cvgg11 --set cifar10 --lr 0.01 --batch_size 256 --weight_decay 0.0006 --epochs 150 --lr_decay_step 50,100  --num_classes 10
    main()
