...
def cResNet152_137(num_classes=10):
    return ResNet(Bottleneck, [3, 8, 31, 3], num_classes=num_classes)

def cResNet152_119(num_classes=10):
    return ResNet(Bottleneck, [3, 8, 25, 3], num_classes=num_classes)

def cResNet152_104(num_classes=10):
    return ResNet(Bottleneck, [3, 8, 20, 3], num_classes=num_classes)

def cResNet152_89(num_classes=10):
    return ResNet(Bottleneck, [3, 8, 15, 3], num_classes=num_classes)

def cResNet152_74(num_classes=10):
    return ResNet(Bottleneck, [3, 8, 10, 3], num_classes=num_classes)

def cResNet152_62(num_classes=10):
    return ResNet(Bottleneck, [3, 8, 6, 3], num_classes=num_classes)
